                  ...
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="#">@lang('service.plast_service_fourreaux')</a>
                      </h2>
                    </div>
              ...
              <div class="card-box-a card-shadow">
                ...
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="#">@lang('service.plast_service_boites')</a>
                      </h2>
                    </div>
                    <div class="card-body-a">
              ...
              <div class="card-box-a card-shadow">
                ...
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="#">@lang('service.plast_service_types') </a>
                      </h2>
                    </div>
                    <div class="card-body-a">
              ...
              <div class="card-box-a card-shadow">
                ...
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="#">@lang('service.plast_service_types_pvc')</a>
                      </h2>
                    </div>
                    <div class="card-body-a">
              ...
              <div class="card-box-a card-shadow">
                ...
                <div class="card-overlay">
                  <div class="card-overlay-a-content">
                    <div class="card-header-a">
                      <h2 class="card-title-a">
                        <a href="#">@lang('service.plast_service_types_coffrets')</a>
                      </h2>
                    </div>
                    <div class="card-body-a">
