          ...
          <div class="row">
              <div class="col-md-12 col-lg-12">
                  <div class="title-single-box">
                      <h1 class="title-single">une entreprise mondiale avec ses racines dans afrique </h1>
                  </div>
              </div>
              <div class="col-md-12 col-lg-12">
                  <div class="body ">
                      <div id="aniimated-thumbnials" class="list-unstyled row clearfix list-wrapper">
                          ...
                          <div class="row"  style="padding-top: 23px;">
                              ...
                              <a href="{{asset('site/assets/img/electrical/project1-img-5.jfif')}}" data-sub-html="Demo Description">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12  clearfix list-item">
                                    <a href="{{asset('site/assets/img/electrical/project1-img-3.jfif')}}" data-sub-html="Demo Description">
                                        <img class="img-responsive thumbnail" width="240" height="150" src="{{asset('site/assets/img/electrical/project1-img-3.jfif')}}">
                                    </a>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12  clearfix list-item">
                                    <a href="{{asset('site/assets/img/electrical/project1-img-4.jfif')}}" data-sub-html="Demo Description">
                                        <img class="img-responsive thumbnail" width="240" height="150" src="{{asset('site/assets/img/electrical/project1-img-4.jfif')}}">
                                    </a>
                                </div>
